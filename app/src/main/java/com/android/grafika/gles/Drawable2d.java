...
public class Drawable2d {
    ...
    private static final float FULL_RECTANGLE_TEX_COORDS2[] = {
    ...
    private static final FloatBuffer FULL_RECTANGLE_TEX_BUF2 =
            GlUtil.createFloatBuffer(FULL_RECTANGLE_TEX_COORDS2);
     ...
     */
    public enum Prefab {
        TRIANGLE, RECTANGLE, FULL_RECTANGLE, FULL_RECTANGLE2
    }
    ...
    public Drawable2d(Prefab shape) {
        switch (shape) {
            ...
            case FULL_RECTANGLE:
                ...
                break;
            case FULL_RECTANGLE2:
                mVertexArray = FULL_RECTANGLE_BUF;
                mTexCoordArray = FULL_RECTANGLE_TEX_BUF2;
                mCoordsPerVertex = 2;
                mVertexStride = mCoordsPerVertex * SIZEOF_FLOAT;
                mVertexCount = FULL_RECTANGLE_COORDS.length / mCoordsPerVertex;
                break;
